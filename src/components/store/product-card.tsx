...
export function ProductCard({
  ...
  return (
    <div className="rounded-xl sm:rounded-2xl border border-slate-200 bg-white hover:border-[#0b1e36]/30 hover:shadow-card-hover transition-all duration-200 flex flex-col justify-between overflow-hidden group">
      <div>
        {/* Product Image Frame */}
