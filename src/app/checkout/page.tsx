              ...
              <CardContent className="p-4 sm:p-5 space-y-3">
                <div className="grid sm:grid-cols-2 gap-3">
                  ...
                  >
                    ...
                    <p className="text-[11px] text-slate-500 leading-normal">
                      Instant transfer via GPay, PhonePe, Paytm, or NetBanking with instant payment verification.
                    </p>
                  </div>
                </div>
                ...
                {(paymentMethod === "UPI" || paymentMethod === "Razorpay") && (
                  <div className="p-4 rounded-xl bg-white border border-teal-500/30 space-y-3 animate-in fade-in duration-200">
                    <div className="flex flex-col sm:flex-row items-center gap-3.5 bg-slate-50 p-3.5 rounded-lg border border-slate-200">
                      <div className="w-24 h-24 rounded-lg bg-white border border-slate-300 p-1.5 flex flex-col items-center justify-center shrink-0">
                        <QrCode className="w-16 h-16 text-[#0b1e36]" />
                      ...
                      <div className="space-y-1 text-xs flex-1">
                        ...
                        <p className="text-[11px] text-slate-500">
                          Proprietor: {COMPANY_DETAILS.ownerName} • {COMPANY_DETAILS.mobile}
                        </p>
                        <div className="flex items-center gap-1.5 pt-1">
                          <span className="font-mono font-bold text-slate-900 bg-white px-2 py-0.5 rounded border border-slate-300 text-[11px]">
